...
class GeminiModelClient extends ModelClient {
  ...
  // The Gemini model to drive the conversation. `gemini-2.5-flash` is fast,
  // cheap, and broadly available. Override via the constructor or
  // `--dart-define=GEMINI_MODEL=...` if your key has access to a newer model.
